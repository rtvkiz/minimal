...
echo "Testing Meilisearch and meilitool parity with production..."
docker run --rm --entrypoint /bin/sh "$IMAGE" -c \
  "meilisearch --version | grep -q \"$EXPECTED\" && meilitool --help >/dev/null"
...
echo "All Meilisearch dev tests passed!"
